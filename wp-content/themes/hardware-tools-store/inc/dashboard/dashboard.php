...
function hardware_tools_store_gettingstarted() {
	add_theme_page( esc_html__('Begin Installation', 'hardware-tools-store'), esc_html__('Begin Installation', 'hardware-tools-store'), 'edit_theme_options', 'hardware-tools-store-guide-page', 'hardware_tools_store_guide');
}
...
if ( ! defined( 'HARDWARE_TOOLS_STORE_BUNDLE_LINK' ) ) {
define('HARDWARE_TOOLS_STORE_BUNDLE_LINK',__('https://www.ovationthemes.com/products/wordpress-bundle','hardware-tools-store'));
}
/**
 * Theme Info Page
 */
function hardware_tools_store_guide() {
	...
	<div class="getting-started__header">
		<div class="header-box-left">
			...
			<p><?php esc_html_e('Version: ', 'hardware-tools-store'); ?><?php echo esc_html($theme['Version']);?></p>
		</div>
	...
	<div class="wrap getting-started">
		<div class="box-container">
			...
			<div class="box-right-main">
				...
				<img class="hardware_tools_store_img_responsive" style="width: 100%;" src="<?php echo esc_url( $theme->get_screenshot() ); ?>" />
				<div class="pro-links">
					<div class="pro-links-inner">
						...
						<a class="button-primary bundle-btn" href="<?php echo esc_url( HARDWARE_TOOLS_STORE_BUNDLE_LINK ); ?>" target="_blank"><?php esc_html_e('WordPress Theme Bundle (125+ Themes at Just $99)', 'hardware-tools-store'); ?></a>
				</div>
